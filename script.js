/* =========================================
   CHRONOS VELOCITY ENGINE v0.1.7 (STABLE)
   ========================================= */
...
// --- 2. MODULES (Defined first to be safe) ---
...
const AudioController = {
    ...
    playAI() { this.playTone(110, 'sawtooth'); }, // Low hum
...
function processMenuInput(val) {
    ...
    if (gameState.step === 'main_menu') {
        ...
        if (val.toLowerCase().startsWith('y')) {
            ...
            printLine(`Protagonist 1: <strong>Lava</strong>`, 'story'); listClasses(); gameState.step = 'player_class';
        } else {
            printLine(`Protagonist 1: <strong>Lava</strong>`, 'story'); listClasses(); gameState.step = 'player_class';
        }
    }
...
function printLine(text, type, animate = true, fxClass = '') { 
    setInputReady(false); // Typing started
